...
import os
print(os.listdir("D:/LAM/sem8/special topic/input/cell_images"))
...
from tf.python.keras.callbacks import EarlyStopping
from keras import backend as k

imagePatches_0 = glob('D:/LAM/sem8/special topic/input/cell_images/Uninfected/*.png', recursive=True)
imagePatches_1 = glob('D:/LAM/sem8/special topic/input/cell_images/Parasitized/*.png', recursive=True)
...
hist = model.fit(x_train,y_train,batch_size = 32, epochs = 1, verbose=1,  validation_split=0.2, callbacks=[mcp])
...
plot_confusion_matrix(cm = cm, normalize= False,cmap ='Reds', target_names = ['Uninfected', 'Parasitized'],title= "Confusion Matrix")
